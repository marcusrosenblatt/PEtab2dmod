...
PEtab(link) is a data format thought for the exchange of models with regard to parameter estimation. It covors SBML models along with their data, parameter and condition specifications. **PEtab2dMod** is a tool to import such PEtab files in dMod. Basic functions are provided for import, visualization and further processing. 
...
The use of PEtab2dMod requires libSBML. The libSBML R source package can be downloaded as tar.gz file from https://sourceforge.net/projects/sbml/files/libsbml/5.18.0/stable/R%20interface/ and installed as R package.
PEtab2Mod is delivered along with the current version of dMod?! 
