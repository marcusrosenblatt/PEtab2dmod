...
The use of PEtab2dMod requires libSBML. The libSBML R source package can be downloaded as tar.gz file as provided by [SBML](https://sourceforge.net/projects/sbml/files/libsbml/5.18.0/stable/R%20interface/) and installed as R package. PEtab2Mod is delivered along with the current version of dMod?! 
...
Now import and plotting functions are availible. As an example we will import and plot [Boehm_JProteomeRes2014](https://pubs.acs.org/doi/abs/10.1021/pr5006923), which is a STAT5 activation model in BaF3-EpoR cells.
